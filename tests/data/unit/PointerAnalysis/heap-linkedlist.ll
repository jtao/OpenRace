...
31:                                               ; preds = %10
  ...
  call void @__cr_alias__(i8* %33, i8* %35), !dbg !57
  ...
  call void @__cr_no_alias__(i8* %37, i8* %39), !dbg !58
  ret void, !dbg !59
}
...
declare dso_local void @__cr_alias__(i8*, i8*) #3
...
define dso_local i32 @main() #0 !dbg !60 {
  ...
  call void @__cr_no_alias__(i8* %13, i8* %19), !dbg !72
  ret i32 0, !dbg !73
}
