...
define dso_local void @check_pointers(%struct.gl_api_table*) #0 !dbg !29 {
  ...
  call void @__cr_alias__(i8* %9, i8* bitcast (void (i32*, i32, float)* @gl_Accum to i8*)), !dbg !43
...
14:                                               ; preds = %10
  ...
  call void @__cr_alias__(i8* %19, i8* bitcast (void (i32*, i32, float)* @gl_Accum to i8*)), !dbg !52
