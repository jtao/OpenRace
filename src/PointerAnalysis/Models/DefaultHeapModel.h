...
class DefaultHeapModel {
 ...
 protected:
  ...
  [[nodiscard]] static llvm::Type *inferCallocType(
      const llvm::Function *fun, const llvm::Instruction *allocSite,
  ...
  [[nodiscard]] static llvm::Type *inferMallocType(
      const llvm::Function *fun, const llvm::Instruction *allocSite,
      int sizeArgNo = 0);
 ...
 public:
  ...
  inline llvm::Type *inferHeapAllocType(
      const llvm::Function *fun, const llvm::Instruction *allocSite) const {
    if (isCalloc(fun)) {
