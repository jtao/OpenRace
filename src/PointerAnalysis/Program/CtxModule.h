...
class CtxModule {
 private:
  ...
  inline std::pair<CallNodeTy *, bool> getOrCreateCallNode(
      const ctx *curCtx, const ctx *preCtx, const llvm::Function *F,
      const llvm::Instruction *I, BeforeNewNode beforeNewNode,
      OnNewDirectNode onNewNode, OnNewInDirect onNewInDirect) {
    // check the signature
    // TODO: add it back!
  ...
  inline std::pair<CallNodeTy *, bool> getOrCreateInDirectCallNode(
      const ctx *C, const llvm::Instruction *I, OnNewInDirectNode callBack,
 ...
 public:
  ...
  template <typename BeforeNewNode, typename OnNewDirectNode,
            typename OnNewInDirectNode, typename OnNewEdge>
  void buildInitCallGraph(BeforeNewNode beforeNewNode,
                          OnNewDirectNode onNewDirect,
                          OnNewInDirectNode onNewIndirect,
                          OnNewEdge onNewEdge) {
    // TODO: add it back
  ...
  [[nodiscard]] inline const CallGraphNode<ctx> *getInDirectNode(
